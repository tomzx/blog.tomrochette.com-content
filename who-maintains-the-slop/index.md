...
Missing intent is what makes AI slop harder to maintain than the human mess it resembles.
...
If they would not have chosen to absorb the change, they should not be forced to, and forcing them is what produces the slop handoff in the first place.
