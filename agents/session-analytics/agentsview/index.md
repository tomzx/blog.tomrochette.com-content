...
Young and active: about 5.9k stars, 663 forks, 114 open issues and PRs as of 2026-09-13, created 2026-02-19.
...
- Pre-1.0 with breaking schema bumps (usage output is at schema version 6 in the docs' JSON contract), so scripts consuming its output churn.
...
- [OpenChamber](../../surfaces/openchamber/index.md) - the session cockpit on the run side rather than the analytics side
- [Claude Code](../../harnesses/claude-code/index.md) - the largest single source of the sessions it indexes
...
- https://www.agentsview.io/docs/token-usage/ - cost computation, the undercount disclosures, the removal of the earlier ccusage benchmark, and the schema version 6 JSON contract (re-verified 2026-09-13)
