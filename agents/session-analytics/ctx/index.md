...
- The 50x token-efficiency claim is self-reported (917 versus 45,734 tokens in its own example, now shown on the site's home page after the comparisons pages were rewritten without it), with no independent benchmark as of 2026-09-20.
- ctx pro's price was long unpublished and now is: $20 USD per month with a 14-day free trial as of 2026-09-20, and the free/pro split still means the headline capability is partially gated.
...
ctx pro is a paid add-on at $20 USD per month with a two-week free trial, no account or credit card required, as of 2026-09-20; a "For Teams" offering also exists.
