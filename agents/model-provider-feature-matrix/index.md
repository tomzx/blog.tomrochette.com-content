...
Everything below was re-verified against live sources on 2026-09-18: each cell traces to the guide's verified pricing table, to provider pages fetched during this run, or to the models.dev list reference the guide uses for model ids, release dates, and context windows.
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| Flagship model | Qwen3.8-Max, $2 / $6 | Claude Fable 5.1, $10 / $50 | DeepSeek V4 Pro, $1.32 / $3.96 peak, the Flash routing cancelled, rates continue | Gemini 3.1 Pro Preview, $2 / $12 | Kimi K3, $2.10 / $10.95 on OpenRouter, Moonshot's page still lists $3 / $15 | GPT-6 Astra, $10 / $50 | GLM-5.3, $1.40 / $4.40 |
...
| Cached input discount | ~ discount stated, rate unpublished | ✓ one tenth, the Fable pair at one fortieth | ✓ about one fiftieth on Flash, the deepest | ✓ about one tenth | ✓ about one ninth on K3, one quarter on k2.7-code | ✓ about one tenth | ✓ about one fifth |
...
- https://platform.openai.com/docs/pricing - GPT-5.6 family, gpt-5.3-codex, and GPT-6 Astra prices, batch discount, long-context doubling (verified 2026-09-18)
- https://docs.claude.com/en/docs/about-claude/pricing - Claude lineup prices, cache multipliers, 1M-context policy (verified 2026-09-18)
- https://cloud.google.com/vertex-ai/generative-ai/pricing - Gemini 3 family prices, intro windows, long-context and batch rates (verified 2026-09-18)
- https://help.aliyun.com/zh/model-studio/billing-for-model-studio - Qwen3.8-Max and Qwen3.8-Flash official prices, batch half price, cache discount, free quota (fetched 2026-09-18)
- https://api-docs.deepseek.com/news/news260910 - the 2026-09-10 V4.1-Flash release and V4 Pro routing announcement behind the DeepSeek column's workhorse and windows cells (fetched 2026-09-10, routing cancelled per the DeepSeek pricing page fetched 2026-09-18)
- https://openrouter.ai/api/v1/models - USD international listings for the Qwen pair, kimi-k2.7-code at $0.71 / $3.21, and kimi-k3 at $2.10 / $10.95 (fetched 2026-09-18)
- https://models.dev - the community model list reference: model ids, release dates, and context windows behind the lineup (fetched 2026-09-18)
