...
Everything below was re-verified against live sources on 2026-09-09: each cell traces to the guide's verified pricing table, to provider pages fetched during this run, or to the models.dev list reference the guide uses for model ids, release dates, and context windows.
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| Flagship model | Qwen3.8-Max, $2 / $6 | Claude Fable 5.1, $10 / $50 | DeepSeek V4 Pro, $1.32 / $3.96 peak | Gemini 3.1 Pro Preview, $2 / $12 | Kimi K3, $3 / $15 | GPT-6 Astra, $10 / $50 | GLM-5.3, $1.40 / $4.40 |
| Workhorse model | Qwen3.8-Max doubles as the workhorse | Claude Sonnet 5, $2 / $10 | V4 Pro covers the class at challenger prices | Gemini 3.1 Pro Preview, $2 / $12 | kimi-k2.7-code, $0.71 / $3.50 | gpt-5.6-terra, $2 / $12 | GLM-5.3 covers the class at $1.40 / $4.40 |
...
| Live pricing windows | ~ 1M-token free quota for new accounts, 90 days | ~ Sonnet 5's planned increase was cancelled | ✓ none, off-peak is standing policy | ~ Flash intro rate ends 2026-12-31 | ~ HighSpeed variant at $1.90 / $8.00 | ~ Sol promo through 2026-11-21 | ~ GLM-5.3-Flash 50% promo ends 2026-09-09 |
...
On the policy rows the field is closer than list prices suggest, and this is the part I check before switching: DeepSeek's cache discount is the deepest at one thirtieth, Alibaba leaves its cache rate unpublished, and batch is half price at the big three and Qwen but unverified at Moonshot and Zhipu.
...
- https://platform.openai.com/docs/pricing - GPT-5.6 family, gpt-5.3-codex, and GPT-6 Astra prices, batch discount, long-context doubling (verified 2026-09-09)
- https://docs.claude.com/en/docs/about-claude/pricing - Claude lineup prices, cache multipliers, 1M-context policy (verified 2026-09-09)
- https://cloud.google.com/vertex-ai/generative-ai/pricing - Gemini 3 family prices, intro windows, long-context and batch rates (verified 2026-09-09)
- https://help.aliyun.com/zh/model-studio/billing-for-model-studio - Qwen3.8-Max and Qwen3.8-Flash official prices, batch half price, cache discount, free quota (fetched 2026-09-09)
- https://openrouter.ai/api/v1/models - USD international listings for the Qwen pair (fetched 2026-09-09)
- https://models.dev - the community model list reference: model ids, release dates, and context windows behind the lineup (fetched 2026-09-09)
