...
- https://platform.openai.com/docs/pricing - GPT-5.6 family, gpt-5.3-codex, and GPT-6 Astra prices, batch discount, long-context doubling (verified 2026-09-21)
...
- https://openrouter.ai/api/v1/models - USD international listings for the Qwen pair, kimi-k2.7-code at $0.71 / $3.21, and kimi-k3 at $1.70 / $8.50 with cache hits at $0.17 (fetched 2026-09-21)
- https://models.dev - the community model list reference: model ids, release dates, and context windows behind the lineup (fetched 2026-09-21)
