...
| Workhorse model | Qwen3.8-Max doubles as the workhorse | Claude Sonnet 5, $2 / $10 | V4 Pro covers the class at challenger prices | Gemini 3.1 Pro Preview, $2 / $12 | kimi-k2.7-code, $0.95 / $4.00 | gpt-5.6-terra, $2 / $12 | GLM-5.3 covers the class at $1.40 / $4.40 |
...
- https://platform.openai.com/docs/pricing - GPT-5.6 family, gpt-5.3-codex, and GPT-6 Astra prices, batch discount, long-context doubling (verified 2026-09-08)
- https://docs.claude.com/en/docs/about-claude/pricing - Claude lineup prices, cache multipliers, 1M-context policy (verified 2026-09-08)
