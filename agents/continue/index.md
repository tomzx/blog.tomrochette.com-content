...
**One config-driven agent across three surfaces**: the VS Code extension (4,103,000 marketplace installs as of 2026-09-09), a JetBrains plugin, and a CLI, all configured through YAML with rules, MCP servers, and any model provider you point it at.
...
As of 2026-09-09 the repo shows about 35.8k stars and 5.3k forks, the docs remain online, and the marketplace extension still installs at a 3.2 average rating.
...
- https://api.github.com/repos/continuedev/continue - stars, forks, last push date as of 2026-09-09
