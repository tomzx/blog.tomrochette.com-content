...
As of 2026-09-21: 27,329 stars, 1,850 forks, 1,247 open issues, created 2025-10-12, pushed 2026-09-21, latest stable release v1.3.0 on 2026-09-15 (after the v1.3.0-rc.1 and rc.2 prereleases of 2026-08-31 and 2026-09-10), 21,046 npm downloads last month, and a v1.3.1-rc.1 prerelease published 2026-09-21 opening the next stable train.
...
- [Gas Town](../../orchestration/gastown/index.md) - the orchestration system beads feeds, from the same org
...
- [AGENTS.md](../../protocols/agents-md/index.md) - the convention `bd init` writes into

## References

- https://github.com/gastownhall/beads - README: commands, Dolt modes, setup, git-free usage
- https://api.github.com/repos/gastownhall/beads - stars, forks, push dates, MIT license as of 2026-09-21
