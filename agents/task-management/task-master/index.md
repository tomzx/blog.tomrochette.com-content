...
As of 2026-09-21: 28,086 stars and 2,617 forks (the largest raw numbers in this category), but the last push landed 2026-04-28 and the last release (0.43.1) on 2026-03-31, while npm still records 56,814 downloads last month.
...
- The open-source repo has been untouched since late April; bugs you file there are not the company's queue.
...
Hamster the product: Free (1 creator, 10 briefs), Team at $40 per creator per month with unlimited briefs, Enterprise at $200 per creator per month with SSO and SOC 2, as of 2026-09-21.

## Price history

| Date | Plan | Change | Source |
| ---- | ---- | ------ | ------ |
| 2026-09-18 | Hamster | Baseline: Free (1 creator, 10 briefs), Team $40/creator/mo, Enterprise $200/creator/mo; the CLI and MCP server stay free under Commons Clause. | [tryhamster.com/pricing](https://tryhamster.com/pricing) |
...
- [GitHub Spec Kit](../../spec-driven-development/spec-kit/index.md): process templates with no runtime to buy; choose it when the spec, not the tracker, is the product.
...
- [GitHub Spec Kit](../../spec-driven-development/spec-kit/index.md) - the spec-first layer, still vendor-neutral
- [Continue](../../surfaces/continue/index.md) - the other 2026 open-source-to-commercial exit this section tracks

## References

- https://github.com/eyaltoledano/claude-task-master - README and the Hamster product links
- https://api.github.com/repos/eyaltoledano/claude-task-master - stars, forks, quiet push dates as of 2026-09-21
...
- https://api.npmjs.org/downloads/point/last-month/task-master-ai - 56,814 downloads last month
