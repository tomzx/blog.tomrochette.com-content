...
Research code with unusually strong product trappings: 17.0k stars, 1.6k forks, 40 open issues and pull requests, and 531 commits on main as of 2026-09-13, created 2026-05-08.
Latest release v0.2.0 (2026-07-02) on PyPI, still the newest as of 2026-09-13; the arXiv paper (2605.23904) is a preprint with no peer-reviewed venue found, and all headline results are the authors' own.
...
- [Ouroboros](../../software-factory/ouroboros/index.md): wraps whole build loops with verification gates; SkillOpt distills experience into one portable artifact, and the two address different layers of self-improvement.
...
- [Ouroboros](../../software-factory/ouroboros/index.md) - the loop-level counterpart in self-improvement
