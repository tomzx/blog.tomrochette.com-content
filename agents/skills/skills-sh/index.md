...
Launched 2026-01-20 by Vercel's labs team; the CLI is MIT-licensed with 32.1k stars, 2.7k forks, and 520 commits as of 2026-09-21.
...
Top of the all-time leaderboard as of 2026-09-21: find-skills (vercel-labs) at 3.5M installs, grill-me (mattpocock/skills) at 1.2M, with the next three slots still held by mattpocock/skills entries (grill-with-docs, improve-codebase-architecture, and tdd), while frontend-design (anthropics/skills) shows 906.4K in sixth, agent-browser (vercel-labs/agent-browser) 895.2K in seventh, and setup-matt-pocock-skills (mattpocock/skills) rounds out the top eight at 866.2K.
Official publisher entries include microsoft/azure-skills, supabase, prisma, and heygen-com/hyperframes.
The publisher mix has gone enterprise: open.feishu.cn (Lark) is the largest publisher at 16.4M aggregate installs, larksuite/cli adds 5.3M, prime-skills/runcomfy-agent-skills sits at 4.6M, and microsoft/azure-skills holds 2.4M, all as of 2026-09-21, after the downward recompute first seen 2026-09-20 extended to azure-skills too (the four publishers showed 17.8M, 11.3M, 11.2M, and 7.1M on 2026-09-18).
The nearest standalone competitor I had verified, skillregistry.io, listed 61 skills as of 2026-09-08, went dark by 2026-09-09, and is back online as of 2026-09-12 with 61 skills (still up as of 2026-09-21), 16,228 total downloads, and 18 contributors, still orders of magnitude behind skills.sh on installs.
...
- https://skills.sh/ - leaderboard, install counts, supported agents, as of 2026-09-21
- https://skills.sh/docs - ranking method (CLI telemetry) and the security disclaimer
- https://skills.sh/audits - Gen/Socket/Snyk audit columns, open.feishu.cn fleet still Pending in 26 of the first 50 rows, as of 2026-09-21
- https://www.skills.sh/microsoft/azure-skills/azure-validate - azure-validate still Pass on all three scanners via its detail page, as of 2026-09-21
- https://github.com/vercel-labs/skills - CLI source, agent path table, telemetry opt-out, 32.1k stars as of 2026-09-21
- https://skillregistry.io/ - nearest standalone competitor, back online 2026-09-12 and still up with 61 skills and 16,228 downloads as of 2026-09-21
