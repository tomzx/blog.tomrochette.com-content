...
The example repository shows 178.4k stars and 21.1k forks but only 56 commits as of 2026-09-26, which tells me it is a distribution artifact, not where the product is built.
...
- [Claude Code](../../harnesses/claude-code/index.md) - the harness that gave this format its largest distribution surface
...
- https://github.com/anthropics/skills - example repo scale and license split, 178,426 stars as of 2026-09-26
