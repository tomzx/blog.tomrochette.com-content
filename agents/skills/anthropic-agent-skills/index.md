...
The example repository shows 177.7k stars and 21k forks but only 55 commits as of 2026-09-22, which tells me it is a distribution artifact, not where the product is built.
...
- https://github.com/anthropics/skills - example repo scale and license split, 177.7k stars as of 2026-09-22
