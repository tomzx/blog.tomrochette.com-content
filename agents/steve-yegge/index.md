...
Active and engaged.
As of 2026-09-09 he maintains a Substack launched within the past year, publishes the "Future of Coding Agents" essay series on his own site (yegge.ai catalog), builds Gas Town, and appears on The Pragmatic Engineer and other podcasts.
...
- Deeply linked to this section's existing profile of Gas Town and the [agent-operations](../openclaw/index.md) landscape.
...
- [beads](../beads/index.md) - the ledger his agent town runs on
