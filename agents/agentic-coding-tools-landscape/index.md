...
[Amp](../amp/index.md) bets on remote execution, with "orbs" that keep working after you close the laptop, and as of September 13, 2026 it is free when you bring your own compute, subscriptions, or keys, with token fees on your own API keys dropped outside Enterprise.
...
[Kimi Code](../kimi-code/index.md) (Moonshot AI, MIT) is the challenger-vendor bet: a big-model vendor shipping the harness tuned for its own cheap models, with subagents, hooks, marketplace skills, and ACP in a single Node.js CLI, at about 18.7k combined stars across its two repositories.
