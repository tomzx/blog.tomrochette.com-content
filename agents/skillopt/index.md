...
Research code with unusually strong product trappings: 16.9k stars, 1.6k forks, 20 open issues, and 531 commits on main as of 2026-09-12, created 2026-05-08.
Latest release v0.2.0 (2026-07-02) on PyPI, still the newest as of 2026-09-12; the arXiv paper (2605.23904) is a preprint with no peer-reviewed venue found, and all headline results are the authors' own.
...
- All results are self-reported on the authors' benchmarks; no independent replication was found as of 2026-09-12.
