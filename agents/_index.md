...
- [Model Access Feature Matrix](model-access/model-access-feature-matrix/index.md) - the sixteen model access providers (gateways, vendor plans including the Claude, ChatGPT, Google, and Grok subscriptions, flat subscriptions) against billing, entry price, quota form, and price-trajectory rows, created 2026-09-26.
