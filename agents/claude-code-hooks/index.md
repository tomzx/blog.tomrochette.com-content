...
The feature ships in the proprietary CLI tracked by the `anthropics/claude-code` repository (about 144.2k stars and roughly 13.2k open issues as of 2026-09-07).
...
- https://github.com/anthropics/claude-code - repository scale, as of 2026-09-07
