...
The feature ships in the proprietary CLI tracked by the `anthropics/claude-code` repository (about 144.5k stars and roughly 12.6k open issues as of 2026-09-10).
A third-party ecosystem exists: an HN search surfaces roughly 330 stories mentioning Claude Code hooks, including dedicated tooling like Graft, whose August 2026 launch thread drew 44 comments.
...
- https://github.com/anthropics/claude-code - repository scale, as of 2026-09-10
