...
The feature ships in the proprietary CLI tracked by the `anthropics/claude-code` repository (about 144.1k stars and roughly 14k open issues as of 2026-09-05).
A third-party ecosystem exists: an HN search surfaces 471 stories mentioning Claude Code hooks, including dedicated tooling like Graft, whose August 2026 launch thread drew 44 comments.
...
- https://github.com/anthropics/claude-code - repository scale, as of 2026-09-05
