...
| Maturity | v1.0.2 tag, v1beta1 API, breaking migrations | v1.0.0, 14 stars, no audit | 1.0.0-rc, no releases, beta | pre-1.0 (v0.4.0), own breaking-changes banner | first stable v2.0 after rewrite | alpha, v0.0.x |
| Community signal | 3.8k stars, Google-backed | 14 stars, 0 issues, footprint is the signal | 1.1k stars, 217-point HN launch | 1.0k stars, 226-point HN launch, quiet since August | 8.2k stars, single dominant author | 8.6k stars, ~116 contributors |
