...
As of 2026-09-08: 389,184 stars and 81,776 forks since creation on 2025-11-24, pushed daily, 6,352 open issues, npm-published.
OpenClaw 2.0 shipped 2026-08-30 (v2026.8.1), by far the largest release in the project's history, roughly half of all pull requests ever merged in one drop from 933 contributors, rebuilding the browser app as a first-class surface and shortening the first-run install, and the cadence has held since, with v2026.9.1 released 2026-09-03 and v2026.9.2 on 2026-09-05.
...
- 6,352 open issues means the tracker is a weather report, not a queue.
...
- https://api.github.com/repos/openclaw/openclaw - stars, forks, issues, dates as of 2026-09-08
- https://api.github.com/repos/openclaw/openclaw/releases - v2026.9.2 release notes, Swarm enabled by default (2026-09-05)
