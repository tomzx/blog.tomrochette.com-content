...
As of 2026-09-09: 80,287 stars and 14,735 forks since creation on 2026-03-02, 5,420 open issues, pushed the day of verification, latest release v2026.831.1 on 2026-09-02 (still current), date-versioned, cloud deployments in waitlist with multi-tenant isolation already shipped per the roadmap.
...
- 5,420 open issues at six months old is a support surface growing as fast as the star count.
...
A hosted cloud is in waitlist with no published pricing as of 2026-09-09.

## Compared to

- [OpenClaw](../openclaw/index.md) (389,271 stars as of 2026-09-09): the employee, not the company; Paperclip's own line is "if OpenClaw is an employee, Paperclip is the company", and it manages OpenClaw instances among others.
...
- https://api.github.com/repos/paperclipai/paperclip - stars, forks, issues, push dates as of 2026-09-09
