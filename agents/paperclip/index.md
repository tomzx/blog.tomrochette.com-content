...
As of 2026-09-10: 80,364 stars and 14,749 forks since creation on 2026-03-02, 5,438 open issues, pushed the day of verification, latest release v2026.831.1 on 2026-09-02 (still current), date-versioned, cloud deployments in waitlist with multi-tenant isolation already shipped per the roadmap.
...
A hosted cloud is in waitlist with no published pricing as of 2026-09-10.

## Compared to

- [OpenClaw](../openclaw/index.md) (389,331 stars as of 2026-09-10): the employee, not the company; Paperclip's own line is "if OpenClaw is an employee, Paperclip is the company", and it manages OpenClaw instances among others.
...
- https://api.github.com/repos/paperclipai/paperclip - stars, forks, issues, push dates as of 2026-09-10
