...
As of 2026-09-06: 80,076 stars and 14,702 forks since creation on 2026-03-02, 5,337 open issues, pushed the day of verification, latest release v2026.831.1 on 2026-09-02 (still current), date-versioned, cloud deployments in waitlist with multi-tenant isolation already shipped per the roadmap.
...
- 5,337 open issues at six months old is a support surface growing as fast as the star count.
...
- [OpenClaw](../openclaw/index.md) (388,988 stars as of 2026-09-06): the employee, not the company; Paperclip's own line is "if OpenClaw is an employee, Paperclip is the company", and it manages OpenClaw instances among others.
