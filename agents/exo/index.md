...
Active: created 2026-05-20, 1,395 stars and 105 forks, pushed 2026-09-12.
...
The community footprint is thin, a 3-point and a 2-point Hacker News thread, so the eval and the repository are nearly the whole evidence base as of 2026-09-12.
...
- A harness that rewrites its own policy is a security reviewer's hardest problem, and there is no published security process as of 2026-09-12.
