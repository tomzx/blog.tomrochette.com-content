...
Dual Apache-2.0 or MIT, written almost entirely by one developer (1,165 commits) with 139 total commit contributors and only 9 with five or more, with a hosted Workspaces product in private beta.
