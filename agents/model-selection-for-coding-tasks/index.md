...
| Input / output per 1M | $0.20 / $1.20 | $2 / $12 | $4 / $20 | $1.75 / $14 | $10 / $50 | $1 / $5 | $2 / $10 | $5 / $25 | $10 / $50 | $0.25 / $1.50 | $0.75 / $3.75 | $2 / $12 | $0.71 / $3.21 | $2.65 / $13.28 | $1.40 / $4.40 | $0.15 / $0.50 | $1.32 / $3.96 | $0.30 / $1.20 | $2 / $6 | $0.15 / $0.47 |
| Cached input per 1M | $0.02 | ~10% of input | ~10% of input | ~10% of input | $1 | ~10% of input | ~10% of input | ~10% of input | 2.5% of input | ~10% of input | ~10% of input | ~10% of input | $0.18 | ~10% of input | ~20% of input | $0.03 | $0.044 | $0.006 | ? | ? |
...
- Claude models from 4.6 onward include the full 1M-token context at standard pricing, and Kimi K3 matches the flat-1M policy at $2.65 in, while OpenAI and Google both double prices past their long-context thresholds, so whole-repository prompting is cheapest on Anthropic and second-cheapest on Kimi.
...
GLM-5.3, 5.2, and 5.1 sit at $1.40 in and $4.40 out per million tokens, with GLM-5 at $1/$3.20, per Z.ai's pricing page as of 2026-09-16.
...
Kimi K3 takes the other flank: $2.65/$13.28 on OpenRouter as of 2026-09-16 while Moonshot's own page still lists $3/$15, always reasoning with a configurable effort, and a flat-price 1M context that only Claude otherwise offers.
...
GLM-5.3-Flash fills the gap between free and $1.40: its 50 percent launch promo expired at 24:00 on 2026-09-09 Singapore time exactly as scheduled, and Z.ai's page billed the $0.15/$0.50 list price with cached reads at $0.03 when I re-checked on 2026-09-16.
...
- Whole-repository reads: DeepSeek from $0.30 in, a 1M-context Claude or Qwen3.8-Max at $2, or Kimi K3 at $2.65 flat on OpenRouter; all four keep 1M pricing flat.
...
GLM-5.3-Flash's half-price launch promo expired at 24:00 on 2026-09-09 Singapore time as scheduled, and Z.ai's page billed the $0.15/$0.50 list price when I re-checked on 2026-09-16.
...
- https://openrouter.ai/api/v1/models - USD international listings for kimi-k3 ($2.65/$13.28), kimi-k2.7-code ($0.71/$3.21, cache hit $0.18), qwen3.8-max-0902 ($2/$6), and qwen3.8-flash ($0.15/$0.47), re-checked 2026-09-16
