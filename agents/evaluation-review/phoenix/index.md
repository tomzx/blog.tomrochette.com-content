...
Mature and busy: 11,558 stars, 1,142 forks, 1,029 open issues and PRs as of 2026-09-21.
Created 2022-11-09, pushed 2026-09-20, platform release arize-phoenix 20.14.0 on 2026-09-18, about 770,000 PyPI downloads a month as of 2026-09-21.
...
- 1,029 open issues and PRs is a large queue even for a project this size.
...
| ---- | ---- | ------ | ------ |
| 2026-09 | Arize AX | Baseline: Phoenix OSS free and self-hosted; AX Free (25k spans/mo), Pro $50/mo, Enterprise custom. | [arize.com/pricing](https://arize.com/pricing/) |
...
- [Langfuse](../langfuse/index.md): the closest feature peer, with a permissive MIT core (under ClickHouse ownership since January 2026) where Phoenix's is ELv2; choose Langfuse when license terms dominate, Phoenix for OpenInference breadth and the AX upgrade path.
...
- 2026-09-16 - Recorded the arize-phoenix 20.12.0 release and refreshed repository counts.
- 2026-09-16 - Langfuse mention linked and expanded into a Compared-to entry.
- 2026-09-18 - Recorded the arize-phoenix 20.14.0 release and refreshed repository counts.
- 2026-09-20 - Added the Price history section tracking price changes in a table, per the new owner rule.
- 2026-09-20 - Corrected the monthly PyPI download figure to about 840,000 per the pypistats source and refreshed repository counts.
...
- [agentsview](../../session-analytics/agentsview/index.md) - session analytics for coding agents, the local-first cousin
