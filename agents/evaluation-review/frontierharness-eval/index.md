...
The repository carries no license as of 2026-09-13, which limits reuse of the task definitions themselves.
...
- [Harness Feature Matrix](../../harnesses/harness-feature-matrix/index.md) - the capability view of the same harnesses this benchmark prices
...
- [Hamel Husain](../../people-and-publications/hamel-husain/index.md) - the eval-methodology lens for reading a 30-task benchmark
