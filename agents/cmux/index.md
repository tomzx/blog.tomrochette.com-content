...
About 26.9k stars and 2.3k forks as of 2026-09-07, created January 28, 2026, with commits landing the day of verification.
...
Pro $40/month billed yearly ($50 month-to-month): cloud agents on isolated VMs, capped at up to 50 Cloud VMs per user, each with its own resources (default 8 GB RAM and 32 GB disk, 4 to 64 GB RAM available, disk up to 256 GB), as of 2026-09-07 (the page now specifies per-VM resources with a 256 GB disk ceiling, replacing the 5 vCPU, 20 GB RAM, and 200 GB shared-pool totals it showed through 2026-09-05), plus unlimited workspaces, the iOS app, and email support.
Team $48/user/month billed yearly ($60 month-to-month) adds centralized billing and priority support; Enterprise adds self-hosted, even air-gapped, cloud execution, SSO/SAML, audit logs, and SOC 2, as of 2026-09-07.
...
- https://github.com/manaflow-ai/cmux - source, license statement, repository scale, as of 2026-09-07
- https://cmux.com/pricing - tiers, per-VM cloud specs, CodeRouter removal, as of 2026-09-07
