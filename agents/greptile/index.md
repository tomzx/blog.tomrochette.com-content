...
The homepage claims 22,000+ teams and names Nvidia, Brex, Substack, PostHog, Zapier, and Retool as users (vendor claim as of 2026-09-10).
...
Starter is free for one active developer with 50 credits per month; Pro is $30 per seat per month including 50 credits per seat, with extra credits at $1 each and TREX reviews costing 3 credits (as of 2026-09-10).
