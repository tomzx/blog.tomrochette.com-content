...
The repository shows about 13.9k stars and 1,656 commits as of 2026-09-25, and PyPI shows release 1.17.0 uploaded September 9, 2026, following 1.16.0 on August 27, in a cadence of monthly-plus releases stretching back to 2023.
The README claims 3M+ monthly downloads and use inside OpenAI, Google, Microsoft, and AWS teams; PyPI counters with roughly 8.4M downloads over the last month as of 2026-09-25, down from roughly 10.0M three days earlier, so the README claim remains conservative but the trend is now steeply negative.
...
- [LangChain](../../retrieval/langchain/index.md) - the framework alternative Instructor explicitly positions against
- [LlamaIndex](../../retrieval/llamaindex/index.md) - the other major framework with its own structured output tooling

## References

- https://github.com/567-labs/instructor - repo: stars, license, retry and streaming features, PydanticAI positioning (as of 2026-09-25)
- https://python.useinstructor.com/ - official docs: from_provider interface, reasking, hooks, provider list
- https://pypi.org/project/instructor/ - release cadence (1.17.0, September 2026), maintainer and authorship
