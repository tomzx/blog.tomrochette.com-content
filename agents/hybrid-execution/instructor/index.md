...
The repository shows about 13.9k stars and 1,656 commits as of 2026-09-18, and PyPI shows release 1.17.0 uploaded September 9, 2026, following 1.16.0 on August 27, in a cadence of monthly-plus releases stretching back to 2023.
The README claims 3M+ monthly downloads and use inside OpenAI, Google, Microsoft, and AWS teams; PyPI counters with roughly 10.0M downloads over the last month as of 2026-09-22, down from roughly 14.2M a day earlier, so the README claim remains conservative but the trend is now steeply negative.
...
- https://github.com/567-labs/instructor - repo: stars, license, retry and streaming features, PydanticAI positioning (as of 2026-09-18)
