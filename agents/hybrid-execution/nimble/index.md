...
**Active and eight days old, with a near-zero HN footprint and the strongest verification artifacts of any project in the wave.**
The repository was created 2026-09-18 and pushed 2026-09-24, with about 1,800 stars and 139 forks as of 2026-09-26; the weights were created 2026-09-18 and show about 2,800 downloads and 193 likes.
...
- The repository ships no license file as of 2026-09-26 (GitHub's API reports none, and no LICENSE exists at any conventional path), so the code and the curated data are technically all rights reserved even though the weights are Apache-2.0.
...
- https://github.com/bespokelabsai/nimble - repository: created 2026-09-18, about 1,800 stars, 139 forks, no license file (GitHub API and contents listing, as of 2026-09-26)
...
- https://huggingface.co/bespokelabs/Bespoke-Nimble-9B - weights: Apache-2.0, created 2026-09-18, about 2,800 downloads, 193 likes (as of 2026-09-26)
