...
Training uses reinforcement learning against strictly proper scoring rules, the method both this lab and TypeSafe call RLCD, and the models ship as a `pip install laya` package (0.3.6 as of 2026-09-22) rather than a hosted API.
...
Days old and compounding fast, as of 2026-09-22.
The main repository was created 2026-09-18 and shows about 17,800 stars, laya-mlx about 2,100 since 2026-09-19, with a CoreML port, third-party demo endpoints, and roughly ten community quantizations appearing within days.
The author's launch story, "I built non-autoregressive decision models with RL a year ago" (2026-09-19), drew a 1,338-point Hacker News thread as of 2026-09-22, the largest community footprint of any Jev follow-up, and a follow-up gist thread on running Laya offline on an M4 Mac reached 173 points as of 2026-09-22.
...
On the third-party JevBench board Laya's 421M checkpoint ranks low overall (54.4, intelligence 45.8) but posts the cheapest cost per 1,000 decisions of any ranked system (about $0.0029), which is the trade its model card already advertised.
...
- https://github.com/NandhaKishorM/laya - repository: Apache-2.0, created 2026-09-18, about 17,800 stars, checkpoint table and Router docs (GitHub API, as of 2026-09-22)
- https://laya.convaiinnovations.com/ - the launch site: 33 ms single-pass and 7.2 ms batched claims, benchmark framing
- https://news.ycombinator.com/item?id=49765348 - the launch thread (1,338 points as of 2026-09-22, 2026-09-19): context-limit, novelty, and GLiNER criticisms
- https://pypi.org/project/laya/ - the package: 0.3.6 uploaded 2026-09-22 (0.3.5 on 09-21, 0.3.4 on 09-20)
- https://huggingface.co/convaiinnovations/laya - the primary checkpoint (ModernBERT-large, 421M parameters, 2,681 likes as of 2026-09-22)
- https://github.com/mizorewww/laya-mlx - the MLX runtime: 7-14 ms on M3 Max, about 2,100 stars as of 2026-09-21
- https://news.ycombinator.com/item?id=49777106 - the 173-point offline-Mac thread (2026-09-20) grounding the local-runtimes claim
