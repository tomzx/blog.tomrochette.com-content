...
Training uses reinforcement learning against strictly proper scoring rules, the method both this lab and TypeSafe call RLCD, and the models ship as a `pip install laya` package (0.3.4 as of 2026-09-20) rather than a hosted API.
...
Days old and compounding fast, as of 2026-09-21.
...
The author's launch story, "I built non-autoregressive decision models with RL a year ago" (2026-09-19), drew a 1,305-point Hacker News thread as of 2026-09-21, the largest community footprint of any Jev follow-up, and a follow-up gist thread on running Laya offline on an M4 Mac reached 150 points on 2026-09-20.
The headline comparisons are self-run, but unusually self-critical: the model card carries an "Honest Limits" section conceding that the base checkpoints score near chance on typed-decisions zero-shot (0.362 against a 0.461 majority-class baseline), that the 0.766 headline belongs to a checkpoint fine-tuned on that benchmark's own training split, and that the models ship over-confident until you fit a temperature on your own data.
...
- https://github.com/NandhaKishorM/laya - repository: Apache-2.0, created 2026-09-18, about 5,800 stars, checkpoint table and Router docs (GitHub API, as of 2026-09-21)
- https://laya.convaiinnovations.com/ - the launch site: 33 ms single-pass and 7.2 ms batched claims, benchmark framing
- https://news.ycombinator.com/item?id=49765348 - the launch thread (1,305 points as of 2026-09-21, 2026-09-19): context-limit, novelty, and GLiNER criticisms
- https://pypi.org/project/laya/ - the package: 0.3.4 uploaded 2026-09-20
- https://huggingface.co/convaiinnovations/laya - the primary checkpoint (ModernBERT-large, 421M parameters)
- https://github.com/mizorewww/laya-mlx - the MLX runtime: 7-14 ms on M3 Max, about 2,100 stars as of 2026-09-21
- https://news.ycombinator.com/item?id=49777106 - the 150-point offline-Mac thread (2026-09-20) grounding the local-runtimes claim
