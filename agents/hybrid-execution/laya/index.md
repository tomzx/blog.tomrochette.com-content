...
Training uses reinforcement learning against strictly proper scoring rules, the method both this lab and TypeSafe call RLCD, and the models ship as a `pip install laya` package (0.3.20 as of 2026-09-26) rather than a hosted API.
...
Days old and compounding fast, as of 2026-09-26.
...
- https://github.com/NandhaKishorM/laya - repository: Apache-2.0, created 2026-09-18, about 25,000 stars, checkpoint table and Router docs (GitHub API, as of 2026-09-26)
- https://laya.convaiinnovations.com/ - the launch site: 33 ms single-pass and 7.2 ms batched claims, benchmark framing
- https://news.ycombinator.com/item?id=49765348 - the launch thread (1,356 points as of 2026-09-26, 2026-09-19): context-limit, novelty, and GLiNER criticisms
- https://pypi.org/project/laya/ - the package: 0.3.20 as of 2026-09-25 (0.3.6 on 09-22, 0.3.5 on 09-21, 0.3.4 on 09-20)
- https://huggingface.co/convaiinnovations/laya - the primary checkpoint (ModernBERT-large, 421M parameters, 3,731 likes as of 2026-09-26)
- https://github.com/mizorewww/laya-mlx - the MLX runtime: 7-14 ms on M3 Max, about 6,400 stars as of 2026-09-26
- https://news.ycombinator.com/item?id=49777106 - the 177-point offline-Mac thread (2026-09-20) grounding the local-runtimes claim
