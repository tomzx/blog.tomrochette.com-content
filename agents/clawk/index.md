...
Twenty-eight days without a push after a fast launch cadence is worth watching, but it is not yet a stall at these timescales.
...
- Pre-1.0 with twenty-eight days of quiet as of 2026-09-10, on a single primary platform (macOS), from a small team.
