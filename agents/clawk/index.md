...
Thirty days without a push after a fast launch cadence is worth watching, but it is not yet a stall at these timescales.
...
- Pre-1.0 with thirty days of quiet as of 2026-09-12, on a single primary platform (macOS), from a small team.
