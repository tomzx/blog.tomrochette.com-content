...
Release cadence is extreme: 0.85.0, which added sections, routines, and a new model picker, remains the latest as of 2026-09-13, with dozens of releases since January 2026.
...
Usage-based pricing for cloud compute is planned but not charged yet as of 2026-09-13.
...
- [Claude Code](../../harnesses/claude-code/index.md) - the harness whose sessions Conductor orchestrates
...
- https://conductor.build/changelog - release cadence through 0.85.0
