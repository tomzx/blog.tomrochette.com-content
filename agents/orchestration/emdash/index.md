...
Facts below verified as of 2026-09-20 (domain moved from emdash.ai to emdash.com, the old host 301-redirects).
...
As of 2026-09-20 the repo shows about 5.8k stars and 596 forks; the site claims over 1M downloads.
The v1.2.5 release shipped 2026-09-18, adding multiple accounts per integration and custom agent executable selection.
...
Cloud workspaces and enterprise are quoted by contact; no published per-seat pricing as of 2026-09-18.
...
- [Claude Code](../../harnesses/claude-code/index.md) - the primary CLI most Emdash tasks drive
