...
2,861 stars and 226 forks as of 2026-09-21 on a repo created July 9, 2025, with pushes landing September 21, 2026 (GitHub API).
...
Omnara Cloud now publishes usage-based pricing, a change from the no-pricing-page state I recorded on 2026-08-30: $0 platform fee with no per-seat charges, Omnara-managed models at provider token rates, and Omnara-managed machines at $0.0414 per GiB of memory per hour online (idle machines auto-sleep) plus $0.20016 per GiB of memory per 30 days of retention, re-verified unchanged as of 2026-09-21.
...
- https://github.com/omnara-ai/omnara - repository, Apache-2.0, 2,861 stars as of 2026-09-21
- https://www.omnara.com/pricing - usage-based pricing: $0 platform fee, token-rate models, per-GiB machine runtime and retention (re-verified 2026-09-21)
