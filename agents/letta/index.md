...
Real development moved to `letta-ai/letta-code` (3.2k stars, 3,311 commits).
...
- **The 24.5k-star repo is a tombstone**: the artifact most people find first is explicitly not the product, and the archived V1 server should not run in production.
...
- https://github.com/letta-ai/letta - landing-page status and archived V1 server, stars as of 2026-09-02
