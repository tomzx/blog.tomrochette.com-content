...
**Active and dominant.**
The specification repository shows about 9.2k stars and roughly 4,800 commits as of 2026-09-18.
...
- [Claude Code](../../harnesses/claude-code/index.md) - the harness from MCP's creator, and its heaviest consumer
- [Gemini CLI](../../harnesses/gemini-cli/index.md) - a non-Anthropic client showing the cross-vendor reach
- [Crush](../../harnesses/crush/index.md) - MCP client support across stdio, http, and sse with OAuth
...
- https://github.com/modelcontextprotocol/modelcontextprotocol - spec repository, MIT license, stars and commits as of 2026-09-18
