...
New and extremely loud: 217,979 stars, 25,793 forks, and roughly 16,400 commits as of 2026-09-10, just over four weeks after the repo was created on 2026-08-13.
No stable release exists, only alpha and rc prereleases (latest: dsh-v0.1.5-rc.1 on 2026-09-10), and the README warns there will be compatibility-breaking changes.
The launch thread drew 747 points and 301 comments on Hacker News, with the author answering questions directly.
An ecosystem is already forming: a Tauri desktop port with 1,853 stars, a plugin directory site, and an MCP plugin catalog.
...
- https://github.com/deepseek-ai/deepseek-harness - repository, README, install, MIT license, 217,979 stars as of 2026-09-10
