...
Requests bill at the chosen model's token rates; for example gpt-5.6-luna lists at $0.20/1M input and $1.20/1M output (standard tier) as of 2026-09-07.
...
- https://platform.openai.com/docs/pricing - per-model token rates, no structured-outputs surcharge, batch discounts (as of 2026-09-07)
