...
It works across the Responses, Chat Completions, Assistants, Fine-tuning, and Batch APIs, and current guide examples target the gpt-5.6 and gpt-6-astra model families.
...
Requests bill at the chosen model's token rates; for example gpt-5.6-luna lists at $0.20/1M input and $1.20/1M output (standard tier) as of 2026-09-09.
...
- https://platform.openai.com/docs/pricing - per-model token rates, no structured-outputs surcharge, batch discounts (as of 2026-09-09)
