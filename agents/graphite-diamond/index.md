...
The current surface is graphite.com's AI Reviews page (the graphite.dev domain now redirects there), advertising Graphite Chat with instant reviews, one-click fixes, custom rules, and a claimed sub-5% negative comment rate from benchmark tests.
...
- The HN maintenance question ("another acquisition for talent or will the product be kept and actively maintained?") has no authoritative answer as of 2026-09-12, though Graphite now advertises Cursor Cloud Agents on its pricing page, evidence the review product is still being integrated rather than sunset.
...
**Per-seat, with AI review included from the paid tiers, as of 2026-09-12.**
...
- https://graphite.com/blog/series-b-diamond-launch - the $52M Series B, the Diamond launch, and the October 8, 2025 deprecation banner
...
- https://graphite.com/pricing - Hobby free, Starter $20, Team $40, Enterprise custom, as of 2026-09-12
