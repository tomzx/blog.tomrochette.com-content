...
The repository shows about 13.8k stars and 1,638 commits as of 2026-09-09, and PyPI shows release 1.17.0 uploaded September 9, 2026, following 1.16.0 on August 27, in a cadence of monthly-plus releases stretching back to 2023.
The README claims 3M+ monthly downloads and use inside OpenAI, Google, Microsoft, and AWS teams; PyPI counters with roughly 24M downloads over the last month as of 2026-09-09, so the README claim is if anything conservative.
...
- https://github.com/567-labs/instructor - repo: stars, license, retry and streaming features, PydanticAI positioning (as of 2026-09-09)
