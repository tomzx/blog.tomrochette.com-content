...
The feature ships in the proprietary CLI tracked by the `anthropics/claude-code` repository (about 145.2k stars and roughly 12.4k open issues as of 2026-09-16).
...
- https://github.com/anthropics/claude-code - repository scale, as of 2026-09-16
