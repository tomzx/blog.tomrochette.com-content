...
| Feature | [claude-mem](../claude-mem/index.md) | [Cognee](../cognee/index.md) | [Files](../file-based-agent-memory/index.md) | [Letta](../letta/index.md) | [Mem0](../mem0/index.md) | [Memoryfields](../memoryfields/index.md) | [Zep](../zep/index.md) |
| --- | --- | --- | --- | --- | --- | --- | --- |
| Kind | local plugin, engine plus cloud | OSS platform, library plus cloud | convention, no vendor | platform, harness plus cloud | hosted service, self-hostable | open file format, spec plus tooling | hosted service, enterprise |
