...
- [Cursor](../../surfaces/cursor/index.md) - the tool most visibly shifting from index to grep plus subagents
- [VS Code Copilot](../../surfaces/vscode-copilot/index.md) - semantic indexing moved to the GitHub platform
- [Windsurf](../../surfaces/windsurf/index.md) - the editor whose docs now double down on RAG context as Devin Desktop
