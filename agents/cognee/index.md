...
About 30.7k GitHub stars as of 2026-09-12, repository pushed 2026-09-12, and v1.5.4 (September 4, 2026) still the latest release per the PyPI JSON API.
...
Cloud: Free $0 (one workspace, 1M tokens included, unlimited users), Standard $1.00 per 1M tokens processed plus $5 per additional workspace per month, Enterprise custom with BYO cloud and SLAs, as of 2026-09-12.
...
- https://github.com/topoteretes/cognee - source, Apache-2.0, about 30.7k stars, as of 2026-09-12
- https://www.cognee.ai/ - v1 announcement, integration list, Berkeley Xcelerator, 5M+ SDK runs claim
- https://www.cognee.ai/pricing - cloud tiers, per-token rate, workspace fee, gpt-oss-120b default, Enterprise bi-temporal memory listing, as of 2026-09-12
