...
- [Claude Code Action](https://github.com/anthropics/claude-code-action): the mature single-agent incumbent on the same substrate (about 8.8k stars as of 2026-09-07), better for @claude PR review, weaker on multi-engine guardrails.
...
- https://github.com/github/gh-aw - repository scale, MIT license, as of 2026-09-07
