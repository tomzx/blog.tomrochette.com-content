...
The core product is proprietary: its GitHub org publishes only tooling, an agent CLI, a homebrew tap, an AWS installer, and Python plus TypeScript SDK mirrors, five public repos in total as of 2026-09-12.
...
The homepage, docs, and pricing all describe the agent cloud as of 2026-09-12, and the GitHub org pushed to its CLI, SDK, and homebrew-tap repos on 2026-09-10 and 2026-09-11.
...
- Security posture: zero source retention (code is deleted with the sandbox), SOC 2 Type I certified with Type II in progress as of 2026-09-12, and a BYOC path into your own AWS VPC.
...
- The public footprint is thin: a ten-month blog gap, five public repos, and an agent CLI at 3 stars as of 2026-09-12, so third-party validation is limited.
...
Tokens are billed at cost with no markup, plus a 10% platform fee, with CPU at $0.142/vCPU-hour and memory at $0.024/GB-hour, as of 2026-09-12.
...
Optional enterprise support packages run $5,000 (Standard), $10,000 (Advanced), and $15,000 (Premier) per month as of 2026-09-12.
...
- https://www.ellipsis.dev/ - current product surface: agent cloud framing, $100 credit, SOC 2 status, supported agents, fetched 2026-09-12.
- https://www.ellipsis.dev/pricing - the token-plus-10% model, compute rates, BYOC terms, and support package tiers, fetched 2026-09-12.
- https://www.ellipsis.dev/docs - docs on environments, sandboxes, sessions, the CLI, and the API, fetched 2026-09-12.
- https://www.ellipsis.dev/blog - publishing cadence and post dates, fetched 2026-09-12.
