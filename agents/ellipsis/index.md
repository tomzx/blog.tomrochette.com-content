...
The core product is proprietary: its GitHub org publishes only tooling, an agent CLI, a homebrew tap, and an AWS installer, four public repos in total as of 2026-08-30.
...
The homepage, docs, and pricing all describe the agent cloud as of 2026-08-30, and the GitHub org pushed to its CLI repos on 2026-08-29.
...
- Security posture: zero source retention (code is deleted with the sandbox), SOC 2 Type I certified with Type II in progress as of 2026-08-30, and a BYOC path into your own AWS VPC.
...
- The public footprint is thin: a ten-month blog gap, four public repos, and an agent CLI at 2 stars as of 2026-08-30, so third-party validation is limited.
...
Tokens are billed at cost with no markup, plus a 10% platform fee, with CPU at $0.142/vCPU-hour and memory at $0.024/GB-hour, as of 2026-08-30.
...
- https://www.ellipsis.dev/ - current product surface: agent cloud framing, $100 credit, SOC 2 status, supported agents, fetched 2026-08-30.
- https://www.ellipsis.dev/pricing - the token-plus-10% model, compute rates, BYOC terms, and support package tiers, fetched 2026-08-30.
- https://www.ellipsis.dev/docs - docs on environments, sandboxes, sessions, the CLI, and the API, fetched 2026-08-30.
- https://www.ellipsis.dev/blog - publishing cadence and post dates, fetched 2026-08-30.
- https://www.ellipsis.dev/blog/the-ellipsis-agent-cloud - the July 28, 2026 pivot announcement by the founder, fetched 2026-08-30.
- https://www.ellipsis.dev/blog/ellipsis-raises-a-2m-seed-round - the $2M seed, investor list, and the 13% faster-merge claim, fetched 2026-08-30.
- https://www.ycombinator.com/companies/ellipsis - YC batch (W24), founding date, founders, team size, and active status, fetched 2026-08-30.
- https://hn.algolia.com/api/v1/items/40309719 - the May 9, 2024 Show HN (121 points, 64 comments) with the praise and criticism threads, fetched 2026-08-30.
- https://hn.algolia.com/api/v1/search?query=ellipsis&tags=story - the Algolia search that located both Show HN items, fetched 2026-08-30.
- https://github.com/ellipsis-dev - the public org (four tooling repos, CLI pushed 2026-08-29), verified via the GitHub API on 2026-08-30.
