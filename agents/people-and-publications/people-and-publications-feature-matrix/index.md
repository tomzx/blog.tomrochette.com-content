...
| Builds tools | Yes (agent-skills repo) | Yes (production agents) | Yes (nanoGPT, AutoResearch) | No (platform) | No | Micro tools | Some (evals tooling) | Indexes, does not build harnesses | No | Yes (OLMo, RL tools) | Yes (LLM, Datasette) | Yes (beads; shut Gas Town down in September 2026) | No |
