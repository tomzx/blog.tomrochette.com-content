...
Everything below was verified against live sources on 2026-08-30 and re-verified on 2026-09-02, 2026-09-04, 2026-09-05, 2026-09-06, 2026-09-07, 2026-09-08, 2026-09-09, 2026-09-10, 2026-09-12, 2026-09-13, and 2026-09-16.
...
| Stars | about 15.3k | about 246k | about 48k | about 31k | about 390k | about 23.6k | about 30k | about 35k | about 33k |
...
| Security record | GAIA claim corrected, astroturf flag | edited plagiarism-claim issue, 43.3k open issues | clean so far, category-skepticism thread | clean so far | provider saga plus a 514-point vuln report | HN boundary questions unresolved | pre-1.0 banner, scam-token notice | telemetry auto-accept default | clean so far, thin coverage |
| Status | active, v1.0.4 | active, v2026.9.11, 43.3k open issues | active, PyPI alpha | active, 1.1k open issues | active, v2026.9.4, 7.4k open issues | active, weekly signed releases | active, 48 open issues, pre-1.0 | active, v2.2.1, post-rewrite churn | active, 797 open issues |
...
**The status row's issue counts are inversely proportional to age, not quality: the root carries 7,444 open issues at scale, and the pre-1.0 PicoClaw carries 48, so read the column against its birthday.**

**Hermes is the column that breaks the -claw pattern: it competes on the learning loop rather than the trust ladder, and its about 246k stars against a 43.3k-issue backlog is the trade in one row pair.**
