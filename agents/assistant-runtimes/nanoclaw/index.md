...
NanoClaw is a MIT-licensed Node.js personal agent (nanocoai) that runs each agent in its own Linux container, born as a 500-line rewrite of the OpenClaw idea that now stands at about 30.7k stars.
...
As of 2026-09-13: 30,749 stars and 12,834 forks since creation on 2026-01-31, pushed 2026-09-12, 1,103 open issues.
...
- [Paperclip](../../control-planes/paperclip/index.md) - hiring runtimes like this into a company

## References

- https://github.com/nanocoai/nanoclaw - README: philosophy, channels, vault, isolation model
- https://api.github.com/repos/nanocoai/nanoclaw - stars, forks, issues as of 2026-09-10
