...
**Active and dominant.**
The `anthropics/claude-code` repository shows about 143.5k stars and about 15.5k open issues and pull requests as of 2026-08-30; it hosts plugins, docs, and the issue tracker rather than the CLI source, which is proprietary.
...
- https://github.com/anthropics/claude-code - repository scale (about 143.5k stars) and npm deprecation, as of 2026-08-30
