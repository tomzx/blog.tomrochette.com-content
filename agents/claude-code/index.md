...
**Active and dominant.**
The `anthropics/claude-code` repository shows about 145k stars and about 12.5k open issues and pull requests as of 2026-09-12; it hosts plugins, docs, and the issue tracker rather than the CLI source, which is proprietary.
Shipping pace in 2026 is high: dynamic workflows across tens of parallel subagents (May 28), agent view (May 11), routines (April), computer use (March).
...
- https://github.com/anthropics/claude-code - repository scale (about 145k stars) and npm deprecation, as of 2026-09-12
