...
**Active and dominant.**
The `anthropics/claude-code` repository shows about 144k stars and about 12.9k open issues and pull requests as of 2026-09-08; it hosts plugins, docs, and the issue tracker rather than the CLI source, which is proprietary.
Shipping pace in 2026 is high: agent view (May), dynamic workflows across tens of parallel subagents (May), routines (May), computer use (April).
...
- https://github.com/anthropics/claude-code - repository scale (about 144k stars) and npm deprecation, as of 2026-09-08
