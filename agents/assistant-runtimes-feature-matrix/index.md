...
Everything below was verified against live sources on 2026-08-30 and re-verified on 2026-09-02, 2026-09-04, 2026-09-05, 2026-09-06, 2026-09-07, and 2026-09-08.
...
| Stars | about 15.2k | about 243k | about 48k | about 31k | about 389k | about 23.4k | about 30k | about 35k | about 33k |
...
| Security record | GAIA claim corrected, astroturf flag | edited plagiarism-claim issue, 40.7k open issues | clean so far, category-skepticism thread | clean so far | provider saga plus a 514-point vuln report | HN boundary questions unresolved | pre-1.0 banner, scam-token notice | telemetry auto-accept default | clean so far, thin coverage |
| Status | active, v1.0.4 | active, v2026.9.7, 40.7k open issues | active, PyPI alpha | active, 1.1k open issues | active, v2026.9.2, 6.4k open issues | active, weekly signed releases | active, 51 open issues, pre-1.0 | active, v2.2.0, post-rewrite churn | active, 809 open issues |
...
**The status row's issue counts are inversely proportional to age, not quality: the root carries 6,352 open issues at scale, and the pre-1.0 PicoClaw carries 51, so read the column against its birthday.**

**Hermes is the column that breaks the -claw pattern: it competes on the learning loop rather than the trust ladder, and its 243k stars against a 40.7k-issue backlog is the trade in one row pair.**
