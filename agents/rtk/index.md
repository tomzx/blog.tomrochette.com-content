...
Young and hot: 77,844 stars, 4,906 forks, 1,033 open issues and 1,049 open PRs as of 2026-08-30, created 2026-01-22, pushed the day of verification.
Latest stable is v0.46.0 (2026-08-26) with near-daily release candidates; the project is pre-1.0.
...
- All savings numbers trace to the project or its users; no independent benchmark exists as of 2026-08-30.
- A crates.io name collision is documented in its own README, and the issue backlog is roughly the size of the star count.
