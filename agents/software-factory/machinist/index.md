...
Active and early: created 2026-07-16, 407 stars and 77 forks, pushed 2026-09-13, releases v0.1.0 through v0.4.0 (v0.4.0 on 2026-08-31 still the newest, with 48 commits on main since), with the README labeling it early-access software.
**There is no Hacker News thread or independent coverage as of 2026-09-13, so the missing community footprint is itself the signal, and the repository plus the docs site at machinist.sh are the whole evidence base.**
...
- [Executions Feature Matrix](../../executions/executions-feature-matrix/index.md) - scheduled triggers versus invoked factory runs
