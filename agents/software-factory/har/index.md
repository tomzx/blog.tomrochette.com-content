...
Active and shipping fast: 90 stars and 11 forks since creation on 2026-06-28, and v1.14.1 released 2026-09-07 (v1.0.0 landed 2026-08-28), with releases landing near-daily through September 7 and the last main push on 2026-09-07 per the GitHub API as of 2026-09-13.
...
- **Young at 90 stars**, though daily releases through v1.14.1 signal momentum, not abandonment.
...
HAR HQ, the hosted team layer, published its first pricing (as of 2026-09-13): Team at $400 per month for up to 50 users with $100 in monthly cloud credits included, and Enterprise custom with self-hosted or VPC deployment, SSO, SAML, SCIM, and SLAs.
...
- [Harnesses](../../harnesses/harness-feature-matrix/index.md) are the single coding agents (Claude Code, Codex) that HAR coordinates; this category is the fleet-and-factory layer above them.
...
- [Harness Feature Matrix](../../harnesses/harness-feature-matrix/index.md) - the single coding agents a HAR fleet coordinates
...
- https://github.com/os-factory/har/releases - the release cadence, v1.0.0 through v1.14.1
- https://kerno.io - the sponsor that tests runtime code for coding agents, grounding the verification emphasis
- https://harhq.com - the HAR HQ site, grounding the Team $400 per month and Enterprise custom tiers as of 2026-09-13
