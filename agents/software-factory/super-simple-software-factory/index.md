...
Active, young, and deliberately small: 863 stars and 226 forks since creation on 2026-08-02, with the last push on 2026-08-04, as of 2026-09-18.
...
- [Spec-driven development](../../spec-driven-development/spec-driven-development-feature-matrix/index.md), as in [Spec Kit](../../spec-driven-development/spec-kit/index.md), pulls the plan into a structured pre-agent artifact; SSSF instead makes the whole plan-build-test-review loop a stamped pipeline, spec included but not the point.
- [Hybrid execution](../../hybrid-execution/hybrid-execution-feature-matrix/index.md) covers the deterministic-orchestrates-LLM principle at the layer of structured outputs, whereas SSSF applies it to a full SDLC workflow packaged as a skill.
- [Executions](../../executions/executions-feature-matrix/index.md) is about scheduled and event-triggered runs; SSSF is a factory you invoke by hand or by chain, not a scheduler.
...
- [Spec-driven Development Feature Matrix](../../spec-driven-development/spec-driven-development-feature-matrix/index.md) - the spec-first alternative to a full factory
