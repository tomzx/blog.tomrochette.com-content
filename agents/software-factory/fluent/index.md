...
Active and meaningfully developed: 94 stars and 2 forks since creation on 2026-07-10, 1,965 commits, and v0.4.0 released 2026-09-08 (still the newest release) per the GitHub API as of 2026-09-13.
...
- **Young and opinionated**: it is pre-1.0 with 94 stars, and its EARS behavior specs plus multi-layer pipeline are a heavier ceremony than most teams adopt.
