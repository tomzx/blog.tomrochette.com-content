...
| Agents covered | 60+ formats auto-discovered (Claude Code, Codex, Gemini CLI, Copilot, Cursor, Zed, OpenCode, and more) | ~ major agents documented (Claude Code, Codex, Cursor, Pi, OpenCode, and more), full count unstated |
