...
Products are forming around the convention, notably memU (14.4k stars as of 2026-09-09), which stores memory as a wiki of markdown files shared across Codex, Claude Code, and Cursor.

## Status

**The de facto standard.**
AGENTS.md reports 60k open-source projects carrying the file as of 2026-09-09, and every major harness ships a variant with the same converged features: generator commands (`/init`), nested files, and path scoping.
...
- https://agents.md - the standard, adoption count, and stewardship as of 2026-09-09
...
- https://github.com/NevaMind-AI/memU - a markdown-wiki memory product with real traction (14.4k stars as of 2026-09-09)
