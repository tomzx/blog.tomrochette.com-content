...
**Active.**
Launched January 2025, shipping continuously since, with a four-tier consumer pricing ladder and enterprise availability via BytePlus, as of 2026-08-24.
...
- The separate trae-agent framework is genuinely open source under MIT.
...
Lite $3/month ($5 usage), Pro $10/month ($20 usage, 10 tasks), Pro+ $30/month (3.5x Pro usage, 15 tasks), Ultra $100/month (20x usage, 20 tasks, model early access), as of 2026-08-24.
...
- https://www.trae.ai/pricing - tiers, usage dollars, cloud task concurrency, as of 2026-08-24
- https://github.com/bytedance/trae-agent - the MIT-licensed agent framework, separate from the IDE
