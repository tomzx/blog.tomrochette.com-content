...
Warp's Rust codebase is public under AGPL-3.0 at [warpdotdev/warp](https://github.com/warpdotdev/warp), about 65k stars as of 2026-09-12.
...
Vendor traction is real: the terminal repository counts about 65k stars as of 2026-09-12, and Anthropic published a Warp engineering story on August 26, 2026.
The CLI itself ships as a managed binary with no separate public repository.
Warp has also opened a Factories line: factories-as-code cloud software factories (factory.yaml defining repos, agents, models, and approval gates) with evals, benchmarks, and self-improvement loops, in closed early access priced per agent run with up to $10,000 in free usage as of 2026-09-12.
...
- https://www.warp.dev/pricing - tiers, credits, and enterprise features as of 2026-09-12
...
- https://github.com/warpdotdev/warp - codebase state, AGPL-3.0 license, stars as of 2026-09-12
