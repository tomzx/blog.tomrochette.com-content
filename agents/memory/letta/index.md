...
- **The 24.9k-star repo is a tombstone**: the artifact most people find first is explicitly not the product, and the archived V1 server should not run in production.
