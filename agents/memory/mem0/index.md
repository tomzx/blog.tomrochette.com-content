...
The repository shows about 65.4k stars and 2,628 commits as of 2026-09-16.
...
Starter $19/month, Pro $249/month (graph memory and Dream land at Pro), Enterprise custom with on-prem and SSO, as of 2026-09-16.
...
- [Claude Code](../../harnesses/claude-code/index.md) - a harness whose skills and MCP surfaces Mem0 plugs into
- [OpenCode](../../harnesses/opencode/index.md) - a lean harness to contrast with memory-API-driven context

## References

- https://mem0.ai/ - product surfaces, developer-count claim, deployment options
- https://github.com/mem0ai/mem0 - stars and commits as of 2026-09-16, April 2026 algorithm, OSS-vs-platform disclaimer
- https://mem0.ai/pricing - tier and quota structure as of 2026-09-16 (Hobby free, Starter $19, Pro $249)
