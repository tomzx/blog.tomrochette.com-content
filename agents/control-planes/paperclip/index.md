...
As of 2026-09-25: 82,672 stars and 15,071 forks since creation on 2026-03-02, 5,643 open issues, pushed 2026-09-25, latest release v2026.916.1 on 2026-09-21, date-versioned, cloud deployments in waitlist with multi-tenant isolation already shipped per the roadmap.
...
- 5,643 open issues seven months in is a support surface growing as fast as the star count.
...
A hosted cloud is in waitlist with no published pricing as of 2026-09-18.

## Compared to

- [OpenClaw](../../assistant-runtimes/openclaw/index.md) (about 390k stars as of 2026-09-18): the employee, not the company; Paperclip's own line is "if OpenClaw is an employee, Paperclip is the company", and it manages OpenClaw instances among others.
- [Gas Town](../../orchestration/gastown/index.md): supervision for many coding agents inside one workspace; choose Gas Town for repo work, Paperclip when the goal is a business, not a codebase.
- [beads](../../task-management/beads/index.md) with a plain harness: the ledger-plus-heartbeat pattern you can assemble yourself when a whole company is overkill.
...
- 2026-09-16 - Refreshed scale numbers (80,789 stars, 5,481 open issues) with the v2026.831.1 release still current.
- 2026-09-18 - Release line moved to v2026.916.0 (2026-09-16) and scale numbers refreshed (80,962 stars, 5,497 open issues).
- 2026-09-25 - Release line moved to v2026.916.1 (2026-09-21) and scale numbers refreshed (82,672 stars, 5,643 open issues).

## See also

- [Gas Town](../../orchestration/gastown/index.md) - the repo-scale counterpart to the company-scale control plane
- [Executions Feature Matrix](../../executions/executions-feature-matrix/index.md) - the smaller scheduled-trigger layer Paperclip generalizes
...
- https://api.github.com/repos/paperclipai/paperclip - stars, forks, issues, push dates as of 2026-09-21
