...
- [OpenClaw](../../assistant-runtimes/openclaw/index.md) (about 390k stars as of 2026-09-13): the employee, not the company; Paperclip's own line is "if OpenClaw is an employee, Paperclip is the company", and it manages OpenClaw instances among others.
