...
No cloud tier or paid plan exists as of 2026-09-20, so the cost model is entirely the compute you already have and the model tokens the snippets displace.
