...
28k stars (28,420), 1.5k forks, and 4,550 commits on GitHub, plus 308,528 npm downloads in the last month (2026-08-21 to 2026-09-19), stars, forks, and downloads as of 2026-09-20, with v1.18.0 released 2026-08-08.
...
- [Aider](../../harnesses/aider/index.md): tree-sitter repo maps rank what fits a budget, retrieval-first where Repomix is inclusion-first.
...
- [Tree-sitter code chunking](../../retrieval/tree-sitter-chunking/index.md) - the parser behind both Repomix's compression and fancier chunking strategies
- [Semantic code search in coding tools](../../retrieval/semantic-code-search/index.md) - the indexed-retrieval path this tool deliberately skips
- [Augment Code](../augment-code/index.md) - what paying for retrieval instead looks like
- [Aider](../../harnesses/aider/index.md) - the budgeted repo map as the middle ground
...
- https://api.npmjs.org/downloads/point/last-month/repomix - 308,528 downloads for 2026-08-21 to 2026-09-19
