...
Code is parsed with tree-sitter across 36 code languages (the project site's count as of 2026-09-16), resolving calls, imports, and inheritance edges deterministically with no LLM; docs, PDFs, and images go through a semantic pass using your assistant's model or a configured API key.
...
Growing absurdly fast for its age: 118,127 stars and 1,790 commits in about five months since 2026-04-03, latest release v0.9.62 on 2026-09-15, all as of 2026-09-16, with 266 contributors as of 2026-09-16.
...
- Shipping velocity is exceptional, with a release the day before this re-verification and a published benchmark methodology.
...
- Pre-1.0 with 1,344 open issues and PRs as of 2026-09-16, a nonstandard default branch, and acknowledged PyPI name-squatting on `graphify*` packages.
...
The hosted side now publishes four plans (as of 2026-09-16): Free ($0, one developer, no card, with node, build, and review allowances), Pro ($10/month billed yearly or $15 billed monthly, one developer, uncapped graphs), Teams ($20 per seat/month billed yearly or $29 billed monthly, minimum 2 seats, rising to $28 yearly and $40 monthly after the first 100 teams), and Enterprise (early access, self-hosted, licensed per seat, with the price scoped on a call instead of published), plus free access for qualified MIT and Apache licensed OSS projects.
...
- https://graphify.com/llms-full.txt - the full plan table grounding the pricing section (monthly and annual billing), fetched 2026-09-16
...
- https://github.com/zachsaw/graphify-csharp - the third-party C# port, 64 stars as of 2026-09-16
