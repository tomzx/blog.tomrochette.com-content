...
Growing absurdly fast for its age: 119,153 stars and 1,810 commits in about five months since 2026-04-03, latest release v0.9.63 on 2026-09-16, all as of 2026-09-18, with 253 contributors as of 2026-09-18.
...
- Shipping velocity is exceptional, with another release (v0.9.63) landing the day before this re-verification and a published benchmark methodology.
...
- Pre-1.0 with 1,394 open issues and PRs as of 2026-09-18, a nonstandard default branch, and acknowledged PyPI name-squatting on `graphify*` packages.
