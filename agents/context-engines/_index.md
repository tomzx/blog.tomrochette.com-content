...
- [Graft](graft/index.md) - NanoNets' MIT context layer feeding agents a code graph instead of grep, 8.4k stars in twelve weeks with every benchmark still the vendor's own.
