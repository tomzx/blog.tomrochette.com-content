...
Young with unusual traction: 29,878 stars, 1,862 forks, 152 open issues and PRs as of 2026-09-20, created 2025-12-08.
...
- [LangChain](../../retrieval/langchain/index.md) and [LlamaIndex](../../retrieval/llamaindex/index.md): frameworks for building custom retrieval products; qmd is a finished zero-code product, and the right choice when local files are the whole corpus.
- [Semantic code search](../../retrieval/semantic-code-search/index.md): the workspace-index pattern for codebases; qmd targets prose and notes, and the two compose rather than compete.
...
- [Retrieval Feature Matrix](../../retrieval/retrieval-feature-matrix/index.md) - where the RAG patterns sit
- [Semantic code search](../../retrieval/semantic-code-search/index.md) - the codebase-side counterpart
- [LlamaIndex](../../retrieval/llamaindex/index.md) - the framework alternative
...
- https://api.github.com/repos/tobi/qmd - exact stars, forks, and dates as of 2026-09-20
