...
The core product is proprietary: its GitHub org publishes only tooling, an agent CLI, a homebrew tap, an AWS installer, and Python plus TypeScript SDK mirrors, five public repos in total as of 2026-09-13.
...
The homepage, docs, and pricing all describe the agent cloud as of 2026-09-13, and the GitHub org pushed to its CLI, SDK, and homebrew-tap repos on 2026-09-10 and 2026-09-11.
...
- Security posture: zero source retention (code is deleted with the sandbox), SOC 2 Type I certified with Type II in progress as of 2026-09-13, and a BYOC path into your own AWS VPC.
...
- The public footprint is thin: a ten-month blog gap, five public repos, and an agent CLI at 3 stars as of 2026-09-13, so third-party validation is limited.
...
Tokens are billed at cost with no markup, plus a 10% platform fee, with CPU at $0.142/vCPU-hour and memory at $0.024/GB-hour, as of 2026-09-13.
There are no per-seat fees and no idle charges, and a $100 credit covers the start.
Individuals on a ChatGPT or Claude subscription get the platform free, the on-ramp the homepage now leads with, as of 2026-09-13.
The same published pricing covers the managed SaaS and a BYOC deployment into your own AWS account.
Optional enterprise support packages run $5,000 (Standard), $10,000 (Advanced), and $15,000 (Premier) per month as of 2026-09-13.
...
**Recommended for teams running fleets of coding agents that need budgets, permissions, and searchable logs around Claude Code or Codex.**
...
- [Software Factory Feature Matrix](../../software-factory/software-factory-feature-matrix/index.md) - the feature matrix for this category, where agent cloud platforms are compared row by row.

## References

- https://www.ellipsis.dev/ - current product surface: agent cloud framing, $100 credit, SOC 2 status, supported agents, fetched 2026-09-13.
- https://www.ellipsis.dev/pricing - the token-plus-10% model, compute rates, BYOC terms, and support package tiers, fetched 2026-09-13.
- https://www.ellipsis.dev/docs - docs on environments, sandboxes, sessions, the CLI, and the API, fetched 2026-09-13.
- https://www.ellipsis.dev/blog - publishing cadence and post dates, fetched 2026-09-13.
- https://www.ellipsis.dev/blog/the-ellipsis-agent-cloud - the July 28, 2026 pivot announcement by the founder, fetched 2026-09-13.
- https://www.ellipsis.dev/blog/ellipsis-raises-a-2m-seed-round - the $2M seed, investor list, and the 13% faster-merge claim, fetched 2026-09-13.
- https://www.ycombinator.com/companies/ellipsis - YC batch (W24), founding date, founders, team size, and active status, fetched 2026-09-13.
