...
- The HN maintenance question ("another acquisition for talent or will the product be kept and actively maintained?") has no authoritative answer as of 2026-09-18, though Graphite now advertises Cursor Cloud Agents on its pricing page, evidence the review product is still being integrated rather than sunset.
