...
- The HN maintenance question ("another acquisition for talent or will the product be kept and actively maintained?") has no authoritative answer as of 2026-09-13, though Graphite now advertises Cursor Cloud Agents on its pricing page, evidence the review product is still being integrated rather than sunset.
...
**Per-seat, with AI review included from the paid tiers, as of 2026-09-13.**
...
- [Cursor](../../surfaces/cursor/index.md) - the acquirer, itself since folded into SpaceX
