...
Scale as of 2026-09-13: 17,000+ customers, 6M repositories, and more than 2M reviews per week, versus 2M repos installed and 13M cumulative PR reviews at the Series B a year earlier.
...
- Metering creeps in at the edges: 5 PR reviews per developer per hour on Essentials (fair-use capped, 8 on Team and 10 on Advanced), and the Slack agent bills $0.40 per agent minute.

## Pricing

**Per-seat pricing with a genuinely free open source tier, as of 2026-09-13.**
...
The Slack agent remains usage-billed, at $0.40 per agent minute as of 2026-09-13 (down from $0.50 in early September), and usage-based reviews bill $0.25 per reviewed file beyond included limits.
...
- [Evaluation and Review Feature Matrix](../../evaluation-review/evaluation-review-feature-matrix/index.md) - the category matrix this note joins
...
- https://www.coderabbit.ai/ - product surface, 17K customers and 6M repositories claims as of 2026-09-13
- https://www.coderabbit.ai/pricing - Essentials/Team/Advanced tiers, prices, rate limits, and the $0.40 Slack agent minute as of 2026-09-13
