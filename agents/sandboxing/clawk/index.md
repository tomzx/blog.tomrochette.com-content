...
Launched July 2026 with real traction and currently paused in a pre-1.0 state: 1,010 stars and 39 forks, last push 2026-08-13 at v0.4.0, with the README carrying its own "pre-1.0, expect breaking changes" banner.
...
Thirty-six days without a push after a fast launch cadence is worth watching, but it is not yet a stall at these timescales.
...
- Pre-1.0 with thirty-six days of quiet as of 2026-09-18, on a single primary platform (macOS), from a small team.
