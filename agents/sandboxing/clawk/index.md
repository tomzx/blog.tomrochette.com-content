...
Thirty-one days without a push after a fast launch cadence is worth watching, but it is not yet a stall at these timescales.
...
- Pre-1.0 with thirty-one days of quiet as of 2026-09-13, on a single primary platform (macOS), from a small team.
