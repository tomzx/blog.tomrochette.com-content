...
Young but institutionally backed: 3,825 stars, 502 forks, 212 open issues and PRs as of 2026-09-13, created 2025-08-12, pushed 2026-09-12.
v1.0.0 released 2026-08-28 with v1.0.1 on 2026-09-03 and v1.0.2 on 2026-09-11, twenty-two releases since October 2025, 974 commits.
...
- [Executions Feature Matrix](../../executions/executions-feature-matrix/index.md) - the runs these sandboxes would host
- [agent-skills-open-standard](../../skills/agent-skills-open-standard/index.md) - no relation, but the other infrastructure-flavored standard in the section
