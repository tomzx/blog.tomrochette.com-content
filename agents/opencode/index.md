...
**Very active.**
The repository moved from `sst` to `anomalyco/opencode` and shows about 204.3k stars and 26.6k forks under MIT as of 2026-09-05.
...
- https://github.com/anomalyco/opencode - repository scale, MIT license, desktop builds, as of 2026-09-05
