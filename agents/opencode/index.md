...
**Very active.**
The repository moved from `sst` to `anomalyco/opencode` and shows about 205.8k stars and 26.8k forks under MIT as of 2026-09-08.
...
- https://github.com/anomalyco/opencode - repository scale, MIT license, desktop builds, as of 2026-09-08
