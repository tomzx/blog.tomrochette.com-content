...
**Very active.**
The repository moved from `sst` to `anomalyco/opencode` and shows about 206.2k stars and 26.9k forks under MIT as of 2026-09-10.
...
- https://github.com/anomalyco/opencode - repository scale, MIT license, desktop builds, as of 2026-09-09
