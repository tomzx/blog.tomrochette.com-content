...
**Very active.**
The repository moved from `sst` to `anomalyco/opencode` and shows about 204.8k stars and 26.7k forks under MIT as of 2026-09-06.
...
- https://github.com/anomalyco/opencode - repository scale, MIT license, desktop builds, as of 2026-09-06
