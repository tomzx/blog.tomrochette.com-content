...
Enterprise Code Assist Standard/Enterprise licenses and paid API keys keep working, and the repository is still active: about 107.1k stars, 6,427 commits, nightly and preview release channels as of 2026-09-21.
...
- [Antigravity](../../surfaces/antigravity/index.md): its CLI is the official successor, Go-based and multi-agent; individuals should start there, not with Gemini CLI.
...
- https://github.com/google-gemini/gemini-cli - repository, README free-tier claims, release channels, as of 2026-09-21
