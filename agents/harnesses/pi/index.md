...
Active and ascending: 105,966 stars (past the 100k mark), 13,322 forks, 235 open issues and PRs as of 2026-09-16.
Created 2025-08-09, pushed within a day of verification, releases roughly weekly (v0.85.1 on 2026-09-05).
**The ecosystem is the strongest signal: OpenClaw runs on Pi, and oh-my-pi, a batteries-included fork with about 31.3k stars as of 2026-09-16, exists precisely because some users want the features Pi refuses to ship.**
...
- [OpenClaw](../../assistant-runtimes/openclaw/index.md) - the largest product built on the Pi toolkit
...
- https://github.com/can1357/oh-my-pi - the 31.3k-star batteries-included fork, the counterargument in running code
