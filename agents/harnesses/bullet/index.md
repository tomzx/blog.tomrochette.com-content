...
v1.4.22 as of 2026-09-21, the newest build on both the CLI registry and the desktop releases repository, published September 21, 2026.
The CLI shipped on npm on August 7, 2026 and did 721 downloads in the last week and 1,927 in the last month as of 2026-09-21 (the npm API's windows end September 20).
...
- https://api.npmjs.org/downloads/point/last-month/@trybullet/cli - 1,927 monthly downloads as of 2026-09-21
- https://github.com/trybullet/bullet-releases - desktop release channel, v1.4.22 published September 21, 2026
