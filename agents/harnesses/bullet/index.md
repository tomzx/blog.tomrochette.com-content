...
v1.4.22 as of 2026-09-22, the newest build on both the CLI registry and the desktop releases repository, published September 21, 2026.
The CLI shipped on npm on August 7, 2026 and did 436 downloads in the last week and 2,091 in the last month as of 2026-09-22 (the npm API's windows end September 21).
