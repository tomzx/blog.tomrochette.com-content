...
v1.4.20 as of 2026-09-16, the newest build on both the CLI registry and the desktop releases repository, published September 14, 2026.
The CLI shipped on npm on August 7, 2026 and did 228 downloads in the last week and 3,376 in the last month as of 2026-09-13 (the npm API's windows end September 11).
...
Free access today, explicitly with no subscriptions, as of 2026-09-13.
...
- 2026-09-16 - Moved the current build to v1.4.20, published September 14, 2026 on both npm and the desktop release repository.
...
- https://www.codewithbullet.com - product surface, YC badge, CLI install, free access as of 2026-09-13
...
- https://api.npmjs.org/downloads/point/last-month/@trybullet/cli - 3,376 monthly downloads as of 2026-09-13
- https://github.com/trybullet/bullet-releases - desktop release channel, v1.4.20 published September 14, 2026
