...
Active and extremely fast-moving: 26,776 stars and 5,039 forks as of 2026-09-16, roughly nine weeks after the repo was created on 2026-07-14, last pushed 2026-09-15.
The changelog listed v1.0.30 as current as of 2026-09-11, with 138 releases logged between May 17 and September 9, and the npm distribution (@xai-official/grok, 209,894 downloads in the last month) confirms the roughly one-per-day cadence continues, up to v1.0.34 published 2026-09-16.
...
- https://github.com/xai-org/grok-build - repository state, Apache-2.0 license, 26,776 stars and 5,039 forks as of 2026-09-16 (verified via the GitHub API)
...
- https://x.ai/build/changelog - v1.0.30 current as of 2026-09-11 and the roughly-daily release cadence (fetched via a text-extraction proxy because x.ai blocks non-browser agents; returned 403 to both curl and webfetch on 2026-09-16)
...
- https://api.npmjs.org/downloads/point/last-month/@xai-official/grok - 209,894 downloads in the last month as of 2026-09-16
