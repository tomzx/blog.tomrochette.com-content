...
The repository shows about 27.4k stars under MIT as of 2026-09-22, most recently pushed within a day of verification; component tags ship on their own clocks (the latest release is v7.7.7, published September 22, 2026).
...
- **Popularity claims are ahead of observable evidence**: earlier README versions called it "the most popular open source coding agent", a claim gone from the README by the 2026-09-02 re-verification, though it survives in the repository description as of 2026-09-21, and its star count trails Cline and OpenCode by wide margins, so treat installs-dependent claims as marketing until independently confirmed.
...
Kilo Pass, an optional monthly credit subscription (Starter $19, Pro $49, Expert $199) with up to 50% bonus credits, now sits alongside pay-as-you-go Kilo Gateway on the pricing page, as of 2026-09-22.
...
- https://github.com/Kilo-Org/kilocode - repository scale, license, description as of 2026-09-22
- https://kilo.ai/pricing - tiers, Kilo Pass, credit model, and the Anaconda acquisition banner, as of 2026-09-22
