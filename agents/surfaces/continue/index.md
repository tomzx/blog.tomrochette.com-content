...
**One config-driven agent across three surfaces**: the VS Code extension (4,167,991 marketplace installs as of 2026-09-18), a JetBrains plugin, and a CLI, all configured through YAML with rules, MCP servers, and any model provider you point it at.
...
As of 2026-09-18 the repo shows about 35.9k stars and 5.4k forks, the docs remain online, and the marketplace extension still installs at a 3.2 average rating.
...
- The 3.2 marketplace rating suggests the late-life quality drift that precedes most acquisitions.
...
- [Cline](../../harnesses/cline/index.md): the extension-generation survivor that kept shipping instead of selling; the default open-source choice today.
...
- [Cline](../../harnesses/cline/index.md) - the surviving line of the extension generation
- [Roo Code](../roo-code/index.md) - the pivot death that completed the pattern
- [Semantic code search](../../retrieval/semantic-code-search/index.md) - grounded in Continue's retrieval decisions
- [Tree-sitter chunking](../../retrieval/tree-sitter-chunking/index.md) - its code RAG guide still ranks the strategies
...
- https://api.github.com/repos/continuedev/continue - stars, forks, last push date as of 2026-09-18
...
- https://marketplace.visualstudio.com/items?itemName=Continue.continue - install count and rating, as of 2026-09-18
