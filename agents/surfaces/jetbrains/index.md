...
- Subscription credits are thin enough that BYOK is effectively required for heavy work (verified counts are in the [Junie](../../harnesses/junie/index.md) note).
...
AI Pro is $8.33 per user/month (annual) and AI Ultimate is $25 per user/month, metered in AI credits, re-observed on 2026-09-21, when the junie.jetbrains.com page exposed both numbers to static fetch after hiding them on 2026-09-20.
...
- [Junie](../../harnesses/junie/index.md) - the agent that ships inside these IDEs
...
- https://junie.jetbrains.com/ - plans, credits, and BYOK, as of 2026-09-21
