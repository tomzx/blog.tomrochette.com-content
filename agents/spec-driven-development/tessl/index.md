...
The CLI has not been pushed since 2026-03-05, which is consistent with a web-first roadmap and worth re-checking before adopting (re-confirmed unchanged, now at 70 stars, on 2026-09-16).
...
Platform tiers are now published on tessl.io (free since 2026-09-08, re-verified 2026-09-16): Free at $0 per month with 1,000 credits, Team at $100 per month with 5x the credits, and Enterprise custom.
...
- [Kiro](../../surfaces/kiro/index.md): the other closed, paid spec-first bet, an IDE rather than a platform; Kiro gates credits, Tessl gates the workflow.
...
- [Vibe Kanban](../../orchestration/vibe-kanban/index.md) - the shutdown record for funded agent-layer SaaS

## References

- https://tessl.io - the platform
...
- https://tessl.io/pricing - the Free, Team, and Enterprise tiers verified on 2026-09-16
