...
The CLI has not been pushed since 2026-03-05, which is consistent with a web-first roadmap and worth re-checking before adopting (re-confirmed unchanged, now at 70 stars, on 2026-09-13).
...
Platform tiers are now published on tessl.io (free since 2026-09-08, re-verified 2026-09-13): Free at $0 per month with 1,000 credits, Team at $100 per month with 5x the credits, and Enterprise custom.
