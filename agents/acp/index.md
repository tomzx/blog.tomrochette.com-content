...
The repository shows about 4.2k stars and about 2,200 commits as of 2026-09-08.
The official agents list has grown to roughly 40 entries and now includes Codex CLI (via the protocol project's adapter), the Claude agent (via Zed's SDK adapter), Gemini CLI, Cursor, OpenCode, Goose, Junie, Kiro CLI, Factory Droid, Cline, Kimi CLI, Qwen Code, and GitHub Copilot in public preview since 2026-01-28.
...
- https://github.com/agentclientprotocol/agent-client-protocol - Apache-2.0 repository, SDKs, stars and commits as of 2026-09-08
