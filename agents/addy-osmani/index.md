...
readability: 3
audience_notes: >
  Engineers and engineering leads inside established companies who want hands-on, enterprise-grounded guidance on agentic engineering practice.
...
Active and high-reach as of 2026-09-02.
...
- He writes the leader-plus-practitioner view: verification discipline, review throughput, and scope control around agents, not just demos.
- His claims come from running AI developer experience at Google, so enterprise-scale failure modes like unverifiable output and skill atrophy are first-hand observations.
- The advice ships as artifacts: his agent-skills repository turns the essays into working skills other teams can install and adapt.
- He is willing to argue against the flow, as in "Don't Outsource the Learning", which pushes back on letting agents erode engineer growth.
...
Free to read.
His books are sold commercially, while "Beyond Vibe Coding" has a free online edition.

## Compared to

- [Simon Willison](../simon-willison/index.md): both are hands-on, but Willison experiments as an indie while Osmani reports from inside enterprise constraints and leadership accountability.
- [The Pragmatic Engineer](../the-pragmatic-engineer/index.md): Orosz surveys the org layer across companies from the outside, Osmani shows one enterprise's practice from the inside.
- [Hamel Husain](../hamel-husain/index.md): Husain goes deep on the evaluation loop itself, Osmani on the engineering system and team discipline around agents.
...
- [Rethinking Code Review in the Age of LLMs](../../rethinking-code-review-in-the-age-of-llms/index.md) - the review role his "parts that do not show up in the diff" thesis depends on
- [The Codebase Gardener](../../the-codebase-gardener/index.md) - the long-term codebase stewardship his maintenance-first framing serves
