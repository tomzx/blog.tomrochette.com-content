...
- **Keyboard-driven editing**: add tasks with Enter, reorder with arrow keys, promote with `/`, remove with Backspace.
  Full shortcut table in the [README](https://github.com/TomzxCode/task-stack#readme).
...
**Restart the app to apply the new hotkey.**
...
- **Developers context-switching** between code reviews, bug fixes, and feature work.
  Push the interruption on the stack, pop the interruption when done, resume what you were doing.
