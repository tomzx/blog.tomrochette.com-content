...
Just like there are two strategies in learning systems, exploration and exploitation, I decided that leaning more on the exploration side might provide useful. Instead of spending hours on the same book in a short amount of time (1-3 months), I would instead read bits of many books at once.
