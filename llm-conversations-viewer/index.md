...
type: post
status: finished
tags: [single-page-application, llm]
readability: 5
---

I built something I've wanted for a while within an hour using Claude Code (Sonnet 4.5).
It's a LLM conversations viewer, available for everyone to use at [https://tomzxcode.github.io/llm-conversations-viewer](https://tomzxcode.github.io/llm-conversations-viewer).
...
[Repository here](https://github.com/TomzxCode/llm-conversations-viewer)
