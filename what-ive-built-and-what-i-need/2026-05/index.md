...
I shipped a comprehensive software development lifecycle orchestrator in [agents](https://github.com/tomzx/agents/blob/main/skills/sdlc/SKILL.md) that chains over 20 sub-skills, from issue creation through learnings capture.
...
**[Automated issue triaging in open source projects](https://github.com/tomzx/agents/issues/13).**
I built a [triage-issues](https://github.com/tomzx/agents/blob/main/skills/triage-issues/SKILL.md) skill but have not used it on my own repositories.
...
**[Incremental PR description updates](https://github.com/tomzx/agents/issues/11).**
When I update a PR after the description is written, I need [create-pr-description](https://github.com/tomzx/agents/blob/main/skills/create-pr-description/SKILL.md) to adjust minimally, appending or amending what changed, rather than regenerating the whole thing from scratch.
