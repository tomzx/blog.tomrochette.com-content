...
That repository includes automation to generate static HTML status pages from the output of the [sdlc-status](https://github.com/tomzx/agents/blob/main/skills/sdlc-status/SKILL.md) skill.
Each project's artifacts are reviewed weekly by [sync-sdlc](https://github.com/tomzx/agents/blob/main/skills/sync-sdlc/SKILL.md) to detect and correct drift.
...
The [ghx](https://github.com/TomzxCode/ghx) CLI was introduced and integrated into the review and feedback skills.
It adds inline PR review comments, pending reviews, and comment stashing that the standard `gh` CLI does not support.
...
[create-needs-assessment](https://github.com/tomzx/agents/blob/main/skills/create-needs-assessment/SKILL.md) and [review-needs-assessment](https://github.com/tomzx/agents/blob/main/skills/review-needs-assessment/SKILL.md) evaluate whether a feature addresses a genuine need before investing in feasibility or requirements.
...
[create-message](https://github.com/tomzx/agents/blob/main/skills/create-message/SKILL.md) improves outgoing messages by removing negative tone and adding actionable suggestions.
...
- [Memory that agents manage automatically](https://github.com/tomzx/agents/issues/6)
- [Accuracy pass on daily summaries](https://github.com/tomzx/agents/issues/5)
- [Automatic context clearing between execution and review](https://github.com/tomzx/agents/issues/9)
