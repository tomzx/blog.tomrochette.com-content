...
If you are interested in a more digestible path through the same content I've experienced, I suggest you look up [my suggested path to AGI](../my-suggested-path-to-agi/index.md) article. It basically contains most of the stuff I've gone through myself, but it is organized in a constructive manner to a new comer (at least, in my opinion).
...
### PHP-Brain (2016-02 - ?)
See [PHP-Brain](../prototypes/php-brain/index.md)
...
### Sharp-Brain (2016-03 - ?)
See [Sharp-Brain](../prototypes/php-brain/index.md)
...
See [Knowledge base](../knowledge-base/index.md).
