...
status: finished
type: post
tags: [artificial-general-intelligence, globallm, open-source, fully-ai-generated, llm=glm-4.7]
readability: 3
---
...
[GlobaLLM](https://github.com/TomzxCode/globallm) is an experiment in autonomous open source contribution which attempts to address this question.
