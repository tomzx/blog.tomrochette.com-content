...
I have however yet to see LLMs being used to autonomously execute complex tasks that involve interacting with multiple systems, such as consuming issues from GitHub, imeplementing the necessary code changes, testing them, and producing a pull request.
