...
# Answer
* [Notion.so](http://notion.so/) I use Notion.so to track my day to day tasks and their progress. I also use it to write down any idea I have during the day that I would like to explore at some point in the future. I've described [my task management system in more details](../../../../processes/task-management/index.md).
...
* [Visual Studio Code](https://code.visualstudio.com/) I use [VS Code to take notes](../../../../problems/2020/03/02/index.md) throughout the day as well as to edit files from time to time.
...
* [Quickly recording notes using VS Code](../../../../problems/2020/03/02/index.md)
* [Tools I use daily and can contribute to](../../01/30/index.md)
